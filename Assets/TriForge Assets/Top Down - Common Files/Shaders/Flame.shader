	...
	SubShader
	{
		...
		Pass
		{
			...
			float4 Frag( VertexOutput packedInput ) : SV_Target
			{
				...
				float3 temp_output_50_0 = ( mulTime13 + ( ase_worldPos * _Float0 ) );
				float2 texCoord11 = packedInput.ase_texcoord1.xy * float2( 1,1 ) + ( (( float3( float2( 0,-0.3 ) ,  0.0 ) * temp_output_50_0 )*1.0 + 0.0) + float3( 0,0,0 ) ).xy;
				...
				float2 texCoord24 = packedInput.ase_texcoord1.xy * float2( 1,1 ) + temp_cast_5;
				...
				float3 hdEmission80 = ASEGetEmissionHDRColor(( ( ( tex2DNode1 * temp_output_27_0 ) * _TintColor ) * packedInput.ase_color ).rgb,_Float1,_Float2,GetInverseCurrentExposureMultiplier());
				
				float4 screenPos = packedInput.ase_texcoord2;
				float4 ase_screenPosNorm = screenPos / screenPos.w;
				ase_screenPosNorm.z = ( UNITY_NEAR_CLIP_VALUE >= 0 ) ? ase_screenPosNorm.z : ase_screenPosNorm.z * 0.5 + 0.5;
				float screenDepth55 = LinearEyeDepth(SampleCameraDepth( ase_screenPosNorm.xy ),_ZBufferParams);
				float distanceDepth55 = abs( ( screenDepth55 - LinearEyeDepth( ase_screenPosNorm.z,_ZBufferParams ) ) / ( 3.0 ) );
				float clampResult79 = clamp( ( ( ( tex2DNode1.a * temp_output_27_0 ) * packedInput.ase_color.a ) * distanceDepth55 ) , 0.0 , 1.0 );
				
				surfaceDescription.Color = float3( 0.5, 0.5, 0.5 );
				surfaceDescription.Emission = hdEmission80;
				surfaceDescription.Alpha = clampResult79;
		...
		Pass
		{
					...
					)
			{
				...
				SurfaceDescription surfaceDescription = (SurfaceDescription)0;
				float2 texCoord16 = packedInput.ase_texcoord.xy * float2( 1,1 ) + float2( 0,0 );
				float mulTime13 = _TimeParameters.x * _EffectSpeed;
				float3 ase_worldPos = packedInput.ase_texcoord1.xyz;
				float3 temp_output_50_0 = ( mulTime13 + ( ase_worldPos * _Float0 ) );
				float2 texCoord11 = packedInput.ase_texcoord.xy * float2( 1,1 ) + ( (( float3( float2( 0,-0.3 ) ,  0.0 ) * temp_output_50_0 )*1.0 + 0.0) + float3( 0,0,0 ) ).xy;
				float simplePerlin2D10 = snoise( texCoord11*_DistortionScale );
				simplePerlin2D10 = simplePerlin2D10*0.5 + 0.5;
				float2 temp_cast_2 = (simplePerlin2D10).xx;
				float2 lerpResult17 = lerp( texCoord16 , temp_cast_2 , _DistortionStrength);
				...
				float2 voronoiSmoothId23 = 0;
				float2 temp_cast_5 = (( (0.0*1.0 + ( float3( float2( 0,-0.8 ) ,  0.0 ) * temp_output_50_0 ).x) + 0.0 )).xx;
				float2 texCoord24 = packedInput.ase_texcoord.xy * float2( 1,1 ) + temp_cast_5;
				float2 coords23 = texCoord24 * _DissolveScale;
				float2 id23 = 0;
				float2 uv23 = 0;
				float voroi23 = voronoi23( coords23, time23, id23, uv23, 0, voronoiSmoothId23 );
		...
		Pass
		{
					...
					)
			{
				...
				float3 temp_output_50_0 = ( mulTime13 + ( ase_worldPos * _Float0 ) );
				float2 texCoord11 = packedInput.ase_texcoord3.xy * float2( 1,1 ) + ( (( float3( float2( 0,-0.3 ) ,  0.0 ) * temp_output_50_0 )*1.0 + 0.0) + float3( 0,0,0 ) ).xy;
				float simplePerlin2D10 = snoise( texCoord11*_DistortionScale );
				simplePerlin2D10 = simplePerlin2D10*0.5 + 0.5;
				float2 temp_cast_2 = (simplePerlin2D10).xx;
				float2 lerpResult17 = lerp( texCoord16 , temp_cast_2 , _DistortionStrength);
				...
				float2 voronoiSmoothId23 = 0;
				float2 temp_cast_5 = (( (0.0*1.0 + ( float3( float2( 0,-0.8 ) ,  0.0 ) * temp_output_50_0 ).x) + 0.0 )).xx;
				float2 texCoord24 = packedInput.ase_texcoord3.xy * float2( 1,1 ) + temp_cast_5;
				float2 coords23 = texCoord24 * _DissolveScale;
				float2 id23 = 0;
				float2 uv23 = 0;
				float voroi23 = voronoi23( coords23, time23, id23, uv23, 0, voronoiSmoothId23 );
...
/*ASEBEGIN
Version=18921
1920;0;1920;1019;1502.51;495.8304;1;True;False
Node;AmplifyShaderEditor.WorldPosInputsNode;33;-5137.557,-39.89352;Inherit;False;0;4;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3
Node;AmplifyShaderEditor.RangedFloatNode;47;-5320.416,-309.3759;Inherit;False;Property;_EffectSpeed;Effect Speed;6;0;Create;True;0;0;0;False;0;False;1;2;0.1;10;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;54;-5090.014,132.2609;Inherit;False;Property;_Float0;Float 0;7;0;Create;True;0;0;0;False;0;False;2;2;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleTimeNode;13;-4948.618,-298.0239;Inherit;False;1;0;FLOAT;1;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.SimpleAddOpNode;50;-4722.055,-196.9062;Inherit;False;2;2;0;FLOAT;0;False;1;FLOAT3;0,0,0;False;1;FLOAT3;0
...
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;15;-4374.219,-274.768;Inherit;True;2;2;0;FLOAT2;0,0;False;1;FLOAT3;0,0,0;False;1;FLOAT3;0
...
Node;AmplifyShaderEditor.ScaleAndOffsetNode;20;-4132.273,-7.716888;Inherit;True;3;0;FLOAT;0;False;1;FLOAT;1;False;2;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;18;-3582.18,-277.5841;Inherit;False;Property;_DistortionStrength;Distortion Strength;2;0;Create;True;0;0;0;False;0;False;0.1528869;0.1;0;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;26;-2852.644,777.7291;Inherit;False;Property;_DissolveStrength;Dissolve Strength;3;0;Create;True;0;0;0;False;0;False;1;0.5;0;10;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.SamplerNode;1;-2245.672,-351.0429;Inherit;True;Property;_MainTex;Particle Texture;0;0;Create;False;0;0;0;False;0;False;-1;95103f0f012cb1d488c1fdec2ea9f4be;95103f0f012cb1d488c1fdec2ea9f4be;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.VertexColorNode;7;-1387.425,507.3451;Inherit;False;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.DepthFade;55;-976.6612,648.3498;Inherit;False;True;False;True;2;1;FLOAT3;0,0,0;False;0;FLOAT;3;False;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;9;-955.1988,358.5542;Inherit;True;2;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;57;-563.3408,456.2129;Inherit;True;2;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;81;-869.5098,-267.8304;Inherit;False;Property;_Float1;Float 1;9;0;Create;True;0;0;0;False;0;False;1;1;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;82;-867.5098,-118.8304;Inherit;False;Property;_Float2;Float 2;8;0;Create;True;0;0;0;False;0;False;0;0;0;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.ClampOpNode;79;-222.7011,175.8219;Inherit;False;3;0;FLOAT;0;False;1;FLOAT;0;False;2;FLOAT;1;False;1;FLOAT;0
Node;AmplifyShaderEditor.HDEmissionNode;80;-524.4537,-245.8882;Inherit;False;Luminance;False;3;0;FLOAT3;0,0,0;False;1;FLOAT;0;False;2;FLOAT;0;False;1;FLOAT3;0
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;76;4.342565,0;Float;False;False;-1;2;Rendering.HighDefinition.LitShaderGraphGUI;0;11;New Amplify Shader;7f5cb9c3ea6481f469fdd856555439ef;True;DepthForwardOnly;0;4;DepthForwardOnly;0;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;3;RenderPipeline=HDRenderPipeline;RenderType=Opaque=RenderType;Queue=Geometry=Queue=0;True;5;True;7;d3d11;metal;vulkan;xboxone;xboxseries;playstation;switch;0;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;0;True;-26;False;True;False;False;False;False;0;False;-1;False;False;False;False;False;False;False;True;True;0;True;-7;255;False;-1;255;True;-8;7;False;-1;3;False;-1;1;False;-1;1;False;-1;7;False;-1;1;False;-1;1;False;-1;1;False;-1;False;True;1;False;-1;False;False;True;1;LightMode=DepthForwardOnly;False;False;0;Hidden/InternalErrorShader;0;0;Standard;0;False;0
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;75;4.342565,0;Float;False;False;-1;2;Rendering.HighDefinition.LitShaderGraphGUI;0;11;New Amplify Shader;7f5cb9c3ea6481f469fdd856555439ef;True;SceneSelectionPass;0;3;SceneSelectionPass;0;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;3;RenderPipeline=HDRenderPipeline;RenderType=Opaque=RenderType;Queue=Geometry=Queue=0;True;5;True;7;d3d11;metal;vulkan;xboxone;xboxseries;playstation;switch;0;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;0;True;-26;False;True;False;False;False;False;0;False;-1;False;False;False;False;False;False;False;False;False;True;1;False;-1;False;False;True;1;LightMode=SceneSelectionPass;False;False;0;Hidden/InternalErrorShader;0;0;Standard;0;False;0
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;77;4.342565,0;Float;False;False;-1;2;Rendering.HighDefinition.LitShaderGraphGUI;0;11;New Amplify Shader;7f5cb9c3ea6481f469fdd856555439ef;True;Motion Vectors;0;5;Motion Vectors;0;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;3;RenderPipeline=HDRenderPipeline;RenderType=Opaque=RenderType;Queue=Geometry=Queue=0;True;5;True;7;d3d11;metal;vulkan;xboxone;xboxseries;playstation;switch;0;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;0;True;-26;False;False;False;False;False;False;False;False;False;True;True;0;True;-9;255;False;-1;255;True;-10;7;False;-1;3;False;-1;1;False;-1;1;False;-1;7;False;-1;1;False;-1;1;False;-1;1;False;-1;False;True;1;False;-1;False;False;True;1;LightMode=MotionVectors;False;False;0;Hidden/InternalErrorShader;0;0;Standard;0;False;0
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;73;4.342565,0;Float;False;False;-1;2;Rendering.HighDefinition.LitShaderGraphGUI;0;11;New Amplify Shader;7f5cb9c3ea6481f469fdd856555439ef;True;ShadowCaster;0;1;ShadowCaster;0;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;3;RenderPipeline=HDRenderPipeline;RenderType=Opaque=RenderType;Queue=Geometry=Queue=0;True;5;True;7;d3d11;metal;vulkan;xboxone;xboxseries;playstation;switch;0;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;0;True;-26;False;True;False;False;False;False;0;False;-1;False;False;False;False;False;False;False;False;False;True;1;False;-1;False;False;True;1;LightMode=ShadowCaster;False;False;0;Hidden/InternalErrorShader;0;0;Standard;0;False;0
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;72;4.342565,0;Float;False;True;-1;2;Rendering.HighDefinition.LitShaderGraphGUI;0;11;TriForge/Flame;7f5cb9c3ea6481f469fdd856555439ef;True;Forward Unlit;0;0;Forward Unlit;9;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;3;RenderPipeline=HDRenderPipeline;RenderType=Opaque=RenderType;Queue=Transparent=Queue=0;True;5;True;7;d3d11;metal;vulkan;xboxone;xboxseries;playstation;switch;0;False;True;1;0;True;-20;0;True;-21;1;0;True;-22;0;True;-23;False;False;False;False;False;False;False;False;False;False;False;False;True;0;True;-26;False;False;False;False;False;False;False;False;False;True;True;0;True;-5;255;False;-1;255;True;-6;7;False;-1;3;False;-1;1;False;-1;1;False;-1;7;False;-1;1;False;-1;1;False;-1;1;False;-1;False;True;0;True;-24;True;0;True;-32;False;True;1;LightMode=ForwardOnly;False;False;0;Hidden/InternalErrorShader;0;0;Standard;29;Surface Type;1;  Rendering Pass ;0;  Rendering Pass;1;  Blending Mode;0;  Receive Fog;1;  Distortion;0;    Distortion Mode;0;    Distortion Only;1;  Depth Write;1;  Cull Mode;0;  Depth Test;4;Double-Sided;0;Alpha Clipping;0;Motion Vectors;1;  Add Precomputed Velocity;0;Shadow Matte;0;Cast Shadows;1;DOTS Instancing;0;GPU Instancing;1;Tessellation;0;  Phong;0;  Strength;0.5,False,-1;  Type;0;  Tess;16,False,-1;  Min;10,False,-1;  Max;25,False,-1;  Edge Length;16,False,-1;  Max Displacement;25,False,-1;Vertex Position,InvertActionOnDeselection;1;0;7;True;True;True;True;True;True;False;False;;False;0
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;74;4.342565,0;Float;False;False;-1;2;Rendering.HighDefinition.LitShaderGraphGUI;0;11;New Amplify Shader;7f5cb9c3ea6481f469fdd856555439ef;True;META;0;2;META;0;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;3;RenderPipeline=HDRenderPipeline;RenderType=Opaque=RenderType;Queue=Geometry=Queue=0;True;5;True;7;d3d11;metal;vulkan;xboxone;xboxseries;playstation;switch;0;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;2;False;-1;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;1;LightMode=Meta;False;False;0;Hidden/InternalErrorShader;0;0;Standard;0;False;0
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;78;4.342565,0;Float;False;False;-1;2;Rendering.HighDefinition.LitShaderGraphGUI;0;11;New Amplify Shader;7f5cb9c3ea6481f469fdd856555439ef;True;DistortionVectors;0;6;DistortionVectors;0;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;3;RenderPipeline=HDRenderPipeline;RenderType=Opaque=RenderType;Queue=Geometry=Queue=0;True;5;True;7;d3d11;metal;vulkan;xboxone;xboxseries;playstation;switch;0;False;True;4;1;False;-1;1;False;-1;4;1;False;-1;1;False;-1;True;1;False;-1;1;False;-1;False;False;False;False;False;False;False;False;False;False;False;True;0;True;-26;False;False;False;False;False;False;False;False;False;True;True;0;True;-11;255;False;-1;255;True;-12;7;False;-1;3;False;-1;1;False;-1;1;False;-1;7;False;-1;1;False;-1;1;False;-1;1;False;-1;False;True;2;False;-1;True;3;False;-1;False;True;1;LightMode=DistortionVectors;False;False;0;Hidden/InternalErrorShader;0;0;Standard;0;False;0
...
ASEEND*/
//CHKSM=3E6A3188D2C54FFCF8BB757372068EEE53BC61FE