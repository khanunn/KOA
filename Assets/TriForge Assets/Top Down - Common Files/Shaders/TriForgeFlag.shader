	...
	SubShader
	{
		...
		Pass
		{
			...
			PackedVaryingsMeshToPS VertexFunction(AttributesMesh inputMesh )
			{
				...
				float2 texCoord27 = inputMesh.uv1.xy * float2( 2,-1.54 ) + ase_worldPos.xy;
				float2 panner18 = ( mulTime7 * float2( -1,0 ) + texCoord27);
				float simplePerlin2D36 = snoise( panner18*( 0.2 * _AnimationScale ) );
				float2 texCoord8 = inputMesh.uv1.xy * float2( 5,0.2 ) + ase_worldPos.xy;
				...
				float2 texCoord17 = inputMesh.uv1.xy * float2( 1,1 ) + float2( 0,0 );
						...
						)
			{
				...
				surfaceDescription.BaseColor = ( tex2DNode77 * _Tint ).rgb;
				surfaceDescription.Normal = UnpackNormalScale( tex2D( _Normal, uv_Normal ), 1.0f );
				surfaceDescription.BentNormal = float3( 0, 0, 1 );
				surfaceDescription.CoatMask = 0;
				surfaceDescription.Metallic = tex2DNode54.r;
				...
				surfaceDescription.Smoothness = tex2DNode54.a;
				surfaceDescription.Occlusion = tex2DNode54.g;
				surfaceDescription.Alpha = tex2DNode77.a;
		...
		Pass
		{
			...
			PackedVaryingsMeshToPS VertexFunction(AttributesMesh inputMesh )
			{
				...
				float mulTime7 = _TimeParameters.x * _AnimationSpeed;
				float3 ase_worldPos = GetAbsolutePositionWS( TransformObjectToWorld( (inputMesh.positionOS).xyz ) );
				float2 texCoord27 = inputMesh.ase_texcoord1.xy * float2( 2,-1.54 ) + ase_worldPos.xy;
				float2 panner18 = ( mulTime7 * float2( -1,0 ) + texCoord27);
				float simplePerlin2D36 = snoise( panner18*( 0.2 * _AnimationScale ) );
				float2 texCoord8 = inputMesh.ase_texcoord1.xy * float2( 5,0.2 ) + ase_worldPos.xy;
				float2 panner4 = ( mulTime7 * float2( 0,-1 ) + texCoord8);
				float simplePerlin2D50 = snoise( panner4*( 0.2 * _AnimationScale ) );
				float4 appendResult31 = (float4(( simplePerlin2D36 * 4.0 ) , ( simplePerlin2D50 + -5.0 ) , 0.0 , 0.0));
				float2 texCoord17 = inputMesh.ase_texcoord1.xy * float2( 1,1 ) + float2( 0,0 );
...
Node;AmplifyShaderEditor.RangedFloatNode;63;-3176.34,216.9562;Inherit;False;Property;_AnimationSpeed;Animation Speed;5;0;Create;True;0;0;0;False;0;False;0;4.61;0;10;0;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleTimeNode;7;-2888.762,221.3501;Inherit;False;1;0;FLOAT;1;False;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;61;-2839.523,462.2871;Inherit;False;Property;_AnimationScale;Animation Scale;4;0;Create;True;0;0;0;False;0;False;0;3;0;10;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;56;-1115.275,498.9709;Inherit;False;Property;_AnimationStrength;Animation Strength;3;0;Create;True;0;0;0;False;0;False;0;0.2;0;3;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.ColorNode;2;-1525.413,-587.6088;Inherit;False;Property;_Tint;Tint;0;0;Create;True;0;0;0;False;0;False;1,1,1,0;0.5471698,0.5471698,0.5471698,1;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.SamplerNode;53;-1605.274,-393.5127;Inherit;True;Property;_Normal;Normal;1;0;Create;True;0;0;0;False;0;False;-1;None;44c70ba0ebf9bbd4e800d205cb0ff403;True;0;True;bump;Auto;True;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
WireConnection;66;4;54;1
WireConnection;66;7;54;4
WireConnection;66;8;54;2
WireConnection;66;9;77;4
WireConnection;66;11;32;0
ASEEND*/
//CHKSM=A8634F66E334B0B5AE94E381223C51DA47346B69