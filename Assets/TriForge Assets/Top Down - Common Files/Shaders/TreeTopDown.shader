	...
	SubShader
	{
		...
		Pass
		{
			...
			PackedVaryingsMeshToPS VertexFunction(AttributesMesh inputMesh )
			{
				...
				float2 texCoord53 = inputMesh.uv1.xy * float2( 1,1 ) + float2( 0,0 );
				...
				float3 objToWorld214 = GetAbsolutePositionWS(mul( GetObjectToWorldMatrix(), float4( float3( 0,0,0 ), 1 ) ).xyz);
				...
				float3 rotatedValue59 = RotateAroundAxis( float3(0,0,0), inputMesh.positionOS, lerpResult173, radians( ( ( (-0.4 + (simplePerlin3D80 - 0.0) * (0.6 - -0.4) / (1.0 - 0.0)) + ( _DetailBendingIntensity * simplePerlin3D97 ) ) * 30.0 ) ) );
				...
				#endif
				float3 vertexValue = ( ( texCoord53.y * ( rotatedValue59 - inputMesh.positionOS ) ) * ( TD_WindStrength * _WindMultiplier ) );
						...
						)
			{
				...
				float2 texCoord167 = packedInput.uv2.xy * float2( 1,1 ) + float2( 0,0 );
				...
				float3 objToWorld204 = GetAbsolutePositionWS(mul( GetObjectToWorldMatrix(), float4( float3( 0,0,0 ), 1 ) ).xyz);
				...
				surfaceDescription.BaseColor = staticSwitch212.rgb;
				...
				surfaceDescription.Smoothness = ( tex2DNode3.a * _Smoothness );
				surfaceDescription.Occlusion = lerpResult162;
		...
		Pass
		{
			...
			float4 Frag(PackedVaryingsMeshToPS packedInput  ) : SV_Target
			{
				...
				float2 texCoord167 = packedInput.ase_texcoord3.xy * float2( 1,1 ) + float2( 0,0 );
				#if defined(_GRADIENTUV_UV2)
				float staticSwitch166 = texCoord7.y;
				#elif defined(_GRADIENTUV_UV3)
				float staticSwitch166 = texCoord167.y;
		...
		Pass
		{
			...
			PackedVaryingsMeshToPS VertexFunction(AttributesMesh inputMesh )
			{
				...
				float2 texCoord53 = inputMesh.ase_texcoord1.xy * float2( 1,1 ) + float2( 0,0 );
				float ifLocalVar183 = 0;
				if( TD_WindDirection.x == 0.0 )
				ifLocalVar183 = (float)1;
				float ifLocalVar186 = 0;
...
Node;AmplifyShaderEditor.RangedFloatNode;99;-5156.843,3136.23;Inherit;False;Property;_DetailBendingScale;Detail Bending Scale;7;0;Create;True;0;0;0;False;0;False;5;5;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.Vector3Node;177;-5154.974,1231.878;Inherit;False;Global;TD_WindDirection;TD_WindDirection;18;0;Create;True;0;0;0;False;0;False;0,0,0;0,0,0;0;4;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3
...
Node;AmplifyShaderEditor.SaturateNode;31;-2384.415,-897.7986;Inherit;False;1;0;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;174;-4100.906,1435.215;Inherit;False;Property;_WindDirectionRandomness;Wind Direction Randomness;15;0;Create;True;0;0;0;False;0;False;0;0;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;146;-463.1819,1184.026;Inherit;False;Global;TD_WindStrength;TD_Wind Strength;8;0;Create;True;0;0;0;False;0;False;0.5;0;0;3;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;176;-369.8595,1279.368;Inherit;False;Property;_WindMultiplier;Wind Multiplier;16;0;Create;True;0;0;0;False;0;False;1;2;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;242;-312.3904,422.2164;Inherit;False;Property;_AlphaClip;Alpha Clip;21;0;Create;True;0;0;0;False;0;False;0.5;0.5;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;249;0,0;Float;False;True;-1;2;Rendering.HighDefinition.LightingShaderGraphGUI;0;12;TriForge/Top Down/Tree;53b46d85872c5b24c8f4f0a1c3fe4c87;True;GBuffer;0;0;GBuffer;34;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;3;RenderPipeline=HDRenderPipeline;RenderType=Opaque=RenderType;Queue=Geometry=Queue=0;True;5;True;8;d3d11;metal;vulkan;xboxone;xboxseries;playstation;ps5;switch;0;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;0;True;_CullMode;False;True;True;True;True;True;0;True;_LightLayersMaskBuffer4;False;False;False;False;False;False;False;True;True;0;True;_StencilRefGBuffer;255;False;;255;True;_StencilWriteMaskGBuffer;7;False;;3;False;;1;False;;1;False;;7;False;;1;False;;1;False;;1;False;;False;False;True;0;True;_ZTestGBuffer;False;True;1;LightMode=GBuffer;False;False;0;;0;0;Standard;39;Surface Type;0;0;  Rendering Pass;1;0;  Refraction Model;0;0;    Blending Mode;0;0;    Blend Preserves Specular;1;0;  Back Then Front Rendering;0;0;  Transparent Depth Prepass;0;0;  Transparent Depth Postpass;0;0;  ZWrite;0;0;  Z Test;4;0;Double-Sided;0;0;Alpha Clipping;1;637979012793087538;  Use Shadow Threshold;0;0;Material Type,InvertActionOnDeselection;0;0;  Energy Conserving Specular;1;0;  Transmission,InvertActionOnDeselection;0;0;Forward Only;0;0;Receive Decals;1;0;Receives SSR;1;0;Receive SSR Transparent;0;0;Motion Vectors;1;0;  Add Precomputed Velocity;0;0;Specular AA;0;0;Specular Occlusion Mode;1;0;Override Baked GI;0;0;Depth Offset;0;0;DOTS Instancing;0;0;GPU Instancing;1;0;LOD CrossFade;1;637979012633728491;Tessellation;0;0;  Phong;0;0;  Strength;0.5,False,;0;  Type;0;0;  Tess;16,False,;0;  Min;10,False,;0;  Max;25,False,;0;  Edge Length;16,False,;0;  Max Displacement;25,False,;0;Vertex Position;1;0;0;11;True;True;True;True;True;True;False;False;False;True;True;False;;False;0
...
WireConnection;249;0;212;0
WireConnection;249;1;2;0
WireConnection;249;7;4;0
WireConnection;249;8;162;0
WireConnection;249;9;1;4
WireConnection;249;10;242;0
WireConnection;249;11;145;0
ASEEND*/
//CHKSM=DC1CDB6ECEE0CA8C036894A94225A47272AA8D88