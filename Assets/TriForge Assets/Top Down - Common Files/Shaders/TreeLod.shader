	...
	SubShader
	{
		...
		Pass
		{
						...
						)
			{
				...
				float2 texCoord7 = packedInput.uv1.xy * float2( 1,1 ) + float2( 0,0 );
				float saferPower8 = abs( texCoord7.y );
				float4 lerpResult15 = lerp( temp_output_4_0 , float4( ( desaturateVar11 * _TopBrightness ) , 0.0 ) , saturate( pow( saferPower8 , abs( 2.93 ) ) ));
				
				surfaceDescription.BaseColor = ( lerpResult15 * 1.0 ).rgb;
		...
		Pass
		{
			...
			float4 Frag(PackedVaryingsMeshToPS packedInput  ) : SV_Target
			{
				...
				BuiltinData builtinData;
				GlobalSurfaceDescription surfaceDescription = (GlobalSurfaceDescription)0;
				float2 uv_MainTex1 = packedInput.ase_texcoord2.xy * _MainTex1_ST.xy + _MainTex1_ST.zw;
				float4 tex2DNode3 = tex2D( _MainTex1, uv_MainTex1 );
				float4 temp_output_4_0 = ( ( tex2DNode3 * _Color ) * _MainTextureBrightness );
				float3 desaturateInitialColor11 = temp_output_4_0.rgb;
				float desaturateDot11 = dot( desaturateInitialColor11, float3( 0.299, 0.587, 0.114 ));
				float3 desaturateVar11 = lerp( desaturateInitialColor11, desaturateDot11.xxx, 0.25 );
				float2 texCoord7 = packedInput.ase_texcoord2.zw * float2( 1,1 ) + float2( 0,0 );
				float saferPower8 = abs( texCoord7.y );
				float4 lerpResult15 = lerp( temp_output_4_0 , float4( ( desaturateVar11 * _TopBrightness ) , 0.0 ) , saturate( pow( saferPower8 , abs( 2.93 ) ) ));
...
Node;AmplifyShaderEditor.RangedFloatNode;6;-1714.163,187.5471;Inherit;False;Constant;_Float2;Float 2;5;0;Create;True;0;0;0;False;0;False;2.93;0;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.AbsOpNode;37;-1536.715,191.0476;Inherit;False;1;0;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.WireNode;10;-810.2794,-533.3179;Inherit;False;1;0;COLOR;0,0,0,0;False;1;COLOR;0
Node;AmplifyShaderEditor.PowerNode;8;-1345.191,-84.58684;Inherit;True;True;2;0;FLOAT;0;False;1;FLOAT;1;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;36;-87.86359,231.2144;Inherit;False;Constant;_Float0;Float 0;4;0;Create;True;0;0;0;False;0;False;1;0;0;0;0;1;FLOAT;0
...
WireConnection;48;4;19;0
WireConnection;48;7;19;0
WireConnection;48;9;3;4
ASEEND*/
//CHKSM=C75B6D6FF3CC4374B1C6E50963BF5AAFF53B6063